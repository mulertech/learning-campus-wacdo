...
class AffectationToCollaborateurTest extends KernelTestCase
{
    public function testValidForm(): void
    {
        ...
        $form = self::getContainer()
            ->get('form.factory')
            ->create(AffectationToCollaborateurType::class, $affectation, ['csrf_protection' => false]);
    ...
    public function testInvalidForm(): void
    {
        ...
        $otherRestaurant = FakeRestaurant::new();
